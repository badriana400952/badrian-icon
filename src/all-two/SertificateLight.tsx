...
const SertificateLight: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M19.5 18.5C19.5 18.5 19 17.5 17.5 17.5C16 17.5 15.5 18.5 15.5 18.5" stroke="currentColor" strokeLinecap="round"/>
</svg>
);

export default SertificateLight;
