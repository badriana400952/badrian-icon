...
const FolderSearchLight: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M19.5 19.5L21 21" stroke="currentColor" strokeLinecap="round"/>
</svg>
);

export default FolderSearchLight;
