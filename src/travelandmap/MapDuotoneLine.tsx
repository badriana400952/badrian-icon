...
const MapDuotoneLine: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M4.5 7.5L8.5 5.5V15.5L5.5 17H4.5V7.5Z" fill="currentColor" fillOpacity="0.25"/>
<path d="M19.5 15.5L15.5 17.5V7.5L18.5 6H19.5V15.5Z" fill="currentColor" fillOpacity="0.25"/>
