...
const WidgetAdd: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M17.5 14.0002L17.5 21.0004" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
<path d="M21 17.5001L13.9998 17.5001" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
</svg>
);
