...
const PackageBoxClose: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M12 8V4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
<path d="M11 16H8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
...
export default PackageBoxClose;
