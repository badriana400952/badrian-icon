...
const UserScanLight: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M7.21484 15.7847C7.68758 15.1024 8.37508 14.5254 9.21678 14.1204C10.0585 13.7155 11.0187 13.5 12 13.5C12.9813 13.5 13.9415 13.7155 14.7832 14.1204C15.6249 14.5254 16.3124 15.1024 16.7852 15.7847" stroke="currentColor" strokeLinecap="round"/>
<circle cx="12" cy="9" r="2.5" stroke="currentColor" strokeLinecap="round"/>
</svg>
);

export default UserScanLight;
