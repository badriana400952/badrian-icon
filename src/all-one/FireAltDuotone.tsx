...
const FireAltDuotone: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M7 14C7 16.7614 9.23858 19 12 19C14.7614 19 17 16.7614 17 14" stroke="currentColor" strokeLinecap="round"/>
</svg>
);

export default FireAltDuotone;
