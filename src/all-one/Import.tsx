...
const Import: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M5 16L5 17C5 18.1046 5.89543 19 7 19L17 19C18.1046 19 19 18.1046 19 17V16" stroke="currentColor" strokeWidth="2"/>
</svg>
);
