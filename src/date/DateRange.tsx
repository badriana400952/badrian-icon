...
const DateRange: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} color="currentColor">
    ...
    <path d="M7 3L7 6" stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" />
    <path d="M17 3L17 6" stroke="currentColor" fill="none" strokeWidth="2" strokeLinecap="round" />
