...
const BookSquareKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M12 8.09998V17.66" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default BookSquareKalm;
