...
const GeminiKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M18.6699 20.41C15.8899 15.25 15.8399 9.03007 18.5699 3.82007L18.6999 3.58008" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default GeminiKalm;
