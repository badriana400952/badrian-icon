...
const House2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M2.9502 22L3.0002 9.96999C3.0002 9.35999 3.2902 8.78004 3.7702 8.40004L10.7702 2.95003C11.4902 2.39003 12.5002 2.39003 13.2302 2.95003L20.2302 8.39003C20.7202 8.77003 21.0002 9.34999 21.0002 9.96999V22" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round"/>
