...
const MagicStarKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M21.9099 22L18.8799 18.97" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MagicStarKalm;
