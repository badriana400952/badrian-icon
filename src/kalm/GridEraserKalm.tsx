...
const GridEraserKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M21.61 16.9L18.8 19.7099L15.3 16.2099L18.11 13.39C18.63 12.87 19.5001 12.87 20.0201 13.39L21.6001 14.98C22.1301 15.51 22.13 16.38 21.61 16.9Z" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default GridEraserKalm;
