...
const ShieldTickKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M9.05005 11.8699L10.66 13.4799L14.96 9.17993" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default ShieldTickKalm;
