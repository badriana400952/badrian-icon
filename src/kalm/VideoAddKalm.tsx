...
const VideoAddKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M18.5 16.84V20.2" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default VideoAddKalm;
