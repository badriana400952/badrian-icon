...
const MusicFilterKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M11.84 22C13.044 22 14.02 21.024 14.02 19.82C14.02 18.616 13.044 17.64 11.84 17.64C10.6361 17.64 9.66003 18.616 9.66003 19.82C9.66003 21.024 10.6361 22 11.84 22Z" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M19.82 20.55C21.024 20.55 22 19.574 22 18.37C22 17.166 21.024 16.19 19.82 16.19C18.616 16.19 17.64 17.166 17.64 18.37C17.64 19.574 18.616 20.55 19.82 20.55Z" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14.02 13.6L22 11.42" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MusicFilterKalm;
