...
const CpuChargeKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M8.00977 4V2" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M12.0098 20V22" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M8.00977 20V22" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M12.0002 9.69995L11.0602 11.34C10.8502 11.7 11.0202 12 11.4402 12H12.5602C12.9802 12 13.1502 12.3 12.9402 12.66L12.0002 14.3" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default CpuChargeKalm;
