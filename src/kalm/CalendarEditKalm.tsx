...
const CalendarEditKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M18.7002 16.28C19.0002 17.36 19.8402 18.2 20.9202 18.5" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
export default CalendarEditKalm;
