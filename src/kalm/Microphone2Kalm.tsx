...
const Microphone2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M4.34998 9.64999V11.35C4.34998 15.57 7.77998 19 12 19C16.22 19 19.65 15.57 19.65 11.35V9.64999" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default Microphone2Kalm;
