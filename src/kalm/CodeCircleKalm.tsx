...
const CodeCircleKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M13 9.66998L11 14.33" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default CodeCircleKalm;
