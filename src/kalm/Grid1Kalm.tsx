...
const Grid1Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M2.03003 15.5H22" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
