...
const CpuSettingKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M16.7101 18.59C17.5882 18.59 18.3001 17.8782 18.3001 17C18.3001 16.1219 17.5882 15.41 16.7101 15.41C15.832 15.41 15.1201 16.1219 15.1201 17C15.1201 17.8782 15.832 18.59 16.7101 18.59Z" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
