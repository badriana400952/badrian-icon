...
const GalleryRemoveKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M16.5601 6.94L20.4401 3.06" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round"/>
<path d="M20.4401 6.94L16.5601 3.06" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
export default GalleryRemoveKalm;
