...
const FilterKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M10.93 2.1001L6 10.0001" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default FilterKalm;
