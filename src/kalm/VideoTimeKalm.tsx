...
const VideoTimeKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M18.78 17.09V18.78L17.38 19.62" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default VideoTimeKalm;
