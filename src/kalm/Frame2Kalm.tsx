...
const Frame2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M15.35 12.65L12 16L8.65002 12.65" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default Frame2Kalm;
