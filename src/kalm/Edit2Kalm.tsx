...
const Edit2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M11.8899 5.04999C12.3199 7.80999 14.5599 9.91999 17.3399 10.2" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M3 22H21" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default Edit2Kalm;
