...
const LoginKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M12.65 8.65002L16 12L12.65 15.35" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default LoginKalm;
