...
const Wind2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M2 13.0999L4.5 11.5999C6.04 10.6799 7.96 10.6799 9.5 11.5999C11.04 12.5199 12.96 12.5199 14.5 11.5999C16.04 10.6799 17.96 10.6799 19.5 11.5999L22 13.0999" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
