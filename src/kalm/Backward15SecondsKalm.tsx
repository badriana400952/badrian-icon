...
const Backward15SecondsKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M15.96 10.83H12.9L12.14 13.12H14.43C15.27 13.12 15.96 13.8 15.96 14.65C15.96 15.49 15.28 16.18 14.43 16.18H12.14" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default Backward15SecondsKalm;
