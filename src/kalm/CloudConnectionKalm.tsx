...
const CloudConnectionKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M6.37022 9.50993C2.29022 9.79993 2.30022 15.7099 6.37022 15.9999H16.0302C17.2002 16.0099 18.3302 15.5699 19.2002 14.7799C22.0602 12.2799 20.5302 7.27991 16.7602 6.79991C15.4102 -1.34009 3.62022 1.74993 6.41022 9.50993" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
export default CloudConnectionKalm;
