...
const BackwardItem1Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M17.3801 11V13.62C17.3801 16.31 16.3101 17.38 13.6201 17.38H11.0001V16.15C11.0001 13.9 10.1001 13 7.85011 13H6.62012V10.38C6.62012 7.69 7.69011 6.62 10.3801 6.62H13.0001V7.85001C13.0001 10.1 13.9001 11 16.1501 11H17.3801Z" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default BackwardItem1Kalm;
