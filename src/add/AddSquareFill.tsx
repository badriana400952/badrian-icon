...
const AddSquareFill: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24"  color={props.color || "currentColor"} fill="none" xmlns="http://www.w3.org/2000/svg" {...props} >
