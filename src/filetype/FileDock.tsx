...
const FileDock: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M13 3V7C13 7.94281 13 8.41421 13.2929 8.70711C13.5858 9 14.0572 9 15 9H19" stroke="currentColor" strokeWidth="2"/>
</svg>
);
