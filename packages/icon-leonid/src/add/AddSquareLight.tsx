...
const AddSquareLight: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} color="currentColor">
    <path
      ...
      fill="none"
    />
    <path d="M12 8L12 16" stroke="currentColor" strokeLinejoin="round" />
    <path d="M16 12L8 12" stroke="currentColor" strokeLinejoin="round" />
  </svg>

);

export default AddSquareLight;
