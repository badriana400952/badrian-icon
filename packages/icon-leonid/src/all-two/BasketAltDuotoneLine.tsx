...
const BasketAltDuotoneLine: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M8.5 6.5L6.5 9.5M15.5 6.5L17.5 9.5" stroke="currentColor" strokeLinecap="round"/>
<path d="M10.5 15.5L9.5 12M13.5 15.5L14.5 12" stroke="currentColor" stroke-opacity="0.25" strokeLinecap="round"/>
