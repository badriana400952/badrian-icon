...
const SpeedLight: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M13.5 12.5L15.5 9.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M20.5 14V14.5C20.5 15.0523 20.0523 15.5 19.5 15.5H4.5C3.94772 15.5 3.5 15.0523 3.5 14.5V14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);
