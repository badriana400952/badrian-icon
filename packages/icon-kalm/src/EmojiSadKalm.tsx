...
const EmojiSadKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M13.3601 8.75C14.3601 7.75 15.9901 7.75 17.0001 8.75" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
