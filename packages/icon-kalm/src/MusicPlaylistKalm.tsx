...
const MusicPlaylistKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M15.28 16.83V11.48C15.28 10.34 14.57 10.18 13.84 10.38L11.1 11.13C10.6 11.27 10.26 11.66 10.26 12.23V13.18V13.82V17.74" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default MusicPlaylistKalm;
