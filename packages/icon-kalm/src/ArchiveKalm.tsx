...
const ArchiveKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M10.1799 14H13.8199" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default ArchiveKalm;
