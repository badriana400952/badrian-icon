...
const RefreshRightSquareKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.3799 7.65002L12.4399 9.07002" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default RefreshRightSquareKalm;
