...
const SidebarTopKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.5599 15.5L11.9999 12.94L9.43994 15.5" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default SidebarTopKalm;
