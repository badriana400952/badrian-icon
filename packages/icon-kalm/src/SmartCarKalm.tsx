...
const SmartCarKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M18.7101 8.73992C18.9901 8.08992 18.8901 7.20993 18.3701 6.43993C17.8601 5.66993 17.0801 5.23993 16.3701 5.24993" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M21.8199 9.72998C22.2399 8.21998 21.9399 6.37002 20.8699 4.77002C19.7999 3.17002 18.1999 2.19 16.6399 2" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default SmartCarKalm;
