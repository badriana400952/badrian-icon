...
const SidebarBottomKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.5599 8.5L11.9999 11.06L9.43994 8.5" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default SidebarBottomKalm;
