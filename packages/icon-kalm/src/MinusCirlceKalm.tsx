...
const MinusCirlceKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M7.91992 12H15.9199" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MinusCirlceKalm;
