...
const CalendarRemoveKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M19.0702 20.11L16.9502 18" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.0502 18.02L16.9302 20.14" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
export default CalendarRemoveKalm;
