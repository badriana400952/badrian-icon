...
const HierarchyKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M5.12988 9C5.57988 10.75 7.17988 12.05 9.06988 12.04L12.4999 12.03C15.1199 12.02 17.3499 13.7 18.1699 16.04" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default HierarchyKalm;
