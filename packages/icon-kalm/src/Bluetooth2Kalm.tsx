...
const Bluetooth2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M4.64014 18.64L16.9901 7.31998C17.5001 6.84998 17.4901 6.09997 16.9501 5.64997L13.1001 2.43998C12.1001 1.60998 11.2801 1.98998 11.2801 3.28998V20.71C11.2801 22.01 12.1001 22.39 13.1001 21.56L16.9501 18.35C17.4901 17.9 17.5001 17.15 16.9901 16.68L4.64014 5.35996" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
