...
const GlassKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M5.93994 13.12C5.93994 13.12 8.99994 13 11.9999 14C14.9999 15 17.8299 13.11 17.8299 13.11" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default GlassKalm;
