...
const MusicSquareKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.18 16.06C15.0471 16.06 15.75 15.3571 15.75 14.49C15.75 13.6229 15.0471 12.92 14.18 12.92C13.3129 12.92 12.61 13.6229 12.61 14.49C12.61 15.3571 13.3129 16.06 14.18 16.06Z" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M9.98999 11.04L15.75 9.46997" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MusicSquareKalm;
