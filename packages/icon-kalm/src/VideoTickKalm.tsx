...
const VideoTickKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M16.75 18.5L17.86 19.61L20.26 17.39" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default VideoTickKalm;
