...
const MusicSquareRemoveKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M8.17004 8.83002L13.47 7.38" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M19.0701 19.04L16.9501 16.93" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.0501 16.96L16.9301 19.07" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MusicSquareRemoveKalm;
