...
const EditKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.9099 4.14999C15.5799 6.53999 17.4499 8.40999 19.8499 9.08999" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default EditKalm;
