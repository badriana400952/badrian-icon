...
const PrinterSlashKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M12.9698 15H15.9998V19C15.9998 21 14.9998 22 12.9998 22H10.9998C9.30982 22 8.32982 21.29 8.06982 19.86" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
export default PrinterSlashKalm;
