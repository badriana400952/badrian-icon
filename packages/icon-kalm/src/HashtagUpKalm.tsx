...
const HashtagUpKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M9.9499 6.26001L8.8999 15.73" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M13.1101 6.26001L12.0601 15.73" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.53003 9.41998H16" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6 12.58H15.47" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default HashtagUpKalm;
