...
const Hierarchy2Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M5.12988 15C5.57988 13.25 7.17988 11.95 9.06988 11.96L12.4999 11.97C15.1199 11.98 17.3499 10.3 18.1699 7.95996" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default Hierarchy2Kalm;
