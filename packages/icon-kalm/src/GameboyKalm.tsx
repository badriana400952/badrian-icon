...
const GameboyKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M8.02979 15.3101L10.3298 17.61" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
