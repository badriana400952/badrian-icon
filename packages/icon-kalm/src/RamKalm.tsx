...
const RamKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M13.9702 7.78003H7.97021" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default RamKalm;
