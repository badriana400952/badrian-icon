...
const MessageTickKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M3.43994 17.5L4.42993 18.49L6.55994 16.52" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M8.5 10.5H15.5" stroke="CurrentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default MessageTickKalm;
