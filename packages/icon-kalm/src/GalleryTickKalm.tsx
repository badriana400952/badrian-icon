...
const GalleryTickKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M16 4.99L17.46 6.45L21.36 2.55" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default GalleryTickKalm;
