...
const AlignHorizontallyKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M22.0001 12H19.3101" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default AlignHorizontallyKalm;
