...
const SidebarRightKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M7.96997 9.44L10.53 12L7.96997 14.56" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default SidebarRightKalm;
