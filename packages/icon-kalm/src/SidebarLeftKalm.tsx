...
const SidebarLeftKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M14.9699 9.44L12.4099 12L14.9699 14.56" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default SidebarLeftKalm;
