...
const Export3Kalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M22 6.83V2H17.17" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default Export3Kalm;
