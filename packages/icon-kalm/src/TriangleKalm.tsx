...
const TriangleKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M21.4401 19.9999L12.0001 13.3899L2.56006 19.9999" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12 3V13.39" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default TriangleKalm;
