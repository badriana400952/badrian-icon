...
const MicrophoneKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M9.10999 7.47999C10.89 6.82999 12.83 6.82999 14.61 7.47999" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
