...
const PreviousKalm: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
<path d="M3.76001 18.18V5.82001" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
);

export default PreviousKalm;
